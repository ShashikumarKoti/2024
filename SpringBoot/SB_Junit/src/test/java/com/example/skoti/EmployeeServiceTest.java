...
public class EmployeeServiceTest {
    ...
    @DisplayName("JUnit for saveEmployee with Exception method")
    @Test
    public void saveEmployeeWithExceptionTest() {
        when(employeeRepository.findByEmail(employee.getEmail()))
                .thenReturn(Optional.ofNullable(employee));

        Exception exception = assertThrows(NoSuchElementException.class, () -> employeeServiceImpl.saveEmployee(employee));
